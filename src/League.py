...
class League:
    ...
    def __init__(self, patch="8.24.1", api_key="e29bf7c5e411c43e2db51ceb2255e3d1"):
        ...
        #champId = Champion.Champion.getChampId("Paul", self.dd)
        #self.champions = [Champion.Champion(Champion.Champion.getChampId(name, self.dd), self.championgg, self.dd) for name in self.dd['data']]
